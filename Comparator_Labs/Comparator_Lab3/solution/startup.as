	...
	; Compiler options:
	;
	; -oComparator_Lab3.cof -mComparator_Lab3.map --summary=default \
	; --output=default Comparator_Lab3.p1 --chip=16F690 -P \
...
;	3 bytes of RAM objects in common bank to zero
	...
	movwf	FSR
	movlw	low(__Lcommon+3)		;load the high address+1 into W
